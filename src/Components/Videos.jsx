...
const Videos = () => {
	...
	return (
		<Stack flexDirection={["column", "column", "row"]} h={"100vh"}>
			<VStack w={"full"}>
				<video
					controls
				...
				<VStack w={"full"} p={8} alignItems={"flex-start"} overflow={"auto"}>
					<Heading>Sample video {title}</Heading>
					<Text>
